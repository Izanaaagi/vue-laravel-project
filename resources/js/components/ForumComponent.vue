<template>
  <div class="py-12">
    <div class="max-w-7xl flex flex-row justify-around mx-auto sm:px-6 lg:px-8">
      <router-link class="lg:w-1/3" to="/bigass">
        <div
          class="bg-white transform hover:scale-110 transition duration-700 shadow-xl sm:rounded-lg p-4 h-full w-full">
          <div
            ...
            <p class="leading-relaxed mb-3">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad animi culpa
              illum nam quod vel. Ab accusantium aliquid eligendi et non placeat quod reiciendis tempora.</p>
            <div
